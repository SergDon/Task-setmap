...
public class Main {
    ...
    public static void max(Map<Character, Integer> map) {
        ...
        System.out.println("Определяется Максимальное Значение Поиска: " + c + ", оно составляет " + max);
    }
    ...
    public static void min(Map<Character, Integer> map) {
        ...
        System.out.println();
        System.out.println("Определяется Минимальное Значение Поиска: " + c + ", оно составляет " + min);
    }
}